...
public class TransactionsController : ControllerBase
{
    ...
    public async Task<IActionResult> GetTransactionsPaging(int page)
    {
        ...
        var transactions =  await _transactionService.GetTransactionsPaging(userId, page <= 0 ? page = PageListed.PAGE : page, PageListed.PAGESIZE);
    ...
    public async Task<IActionResult> GetTransactionById(int id)
    {
        ...
        if (transaction is null)
            return NotFound(TRAN_NOT_EXISTS);
    ...
    public async Task<ActionResult> DeleteTransaction(int id)
    {
        ...
        if (!result)
            return NotFound(TRAN_NOT_FOUND);
    ...
    public async Task<ActionResult> InsertTransaction(TransactionDTO transaction)
    {
        ...
        if (!result)
            return NotFound(TRAN_NOT_CREATED);
