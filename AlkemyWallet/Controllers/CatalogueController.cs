...
public class CatalogueController : ControllerBase
{
    ...
    {
        var result = await _catalogueService.GetCataloguesPaging(page <= 0 ? page = PageListed.PAGE : page, PageListed.PAGESIZE);    if (result.totalPages<page) return NotFound(PAGE_NOT_FOUND_MESSAGE);
