...
public static class Constants
{
    ...
    // Account message
    public const string ACC_NOT_FOUND_MESSAGE = "El id de la cuenta que ingreso no fue encontrado o la cuenta no pertenece al usuario.";
    ...
    public const string ACC_DEPOSIT_SUCCESSFUL_MESSAGE = "Deposito Exitoso.";
    ...
    public const string ACC_NOT_MATCHED_MESSAGE =
        "Esta cuenta no le pertenece al usuario que ha ingresado al sistema";


    // User Message
    public const string USER_LOGGED_MESSAGE = "Datos de usuario loggueado";
    public const string USER_EMAIL_OR_PASSWORD_INCORRECT_MESSAGE = "El email o la contraseña no coinciden con lo registrado en la base de datos";
    ...
    public const string USER_INSUFFICIENT_POINTS_MESSAGE = "No tiene los puntos suficientes para adquirir este producto.";
    ...
    public const string FIX_NOT_FOUND_OR_USER_INVALID_MESSAGE = "No existe inversion con ese id o esta intentando consultar inversiones de otros usuarios.";
    ...
    //PAGE ERROR
    public const string PAGE_NOT_FOUND_MESSAGE = "Esta buscando una pagina mas alla de la la ultima";
